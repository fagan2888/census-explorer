'''
Based on code by JoeGermuska from https://github.com/censusreporter/census-pandas
'''

import pandas as pd
import requests

API_URL="http://10.3.11.40:5000/1.0/data/show/{release}?table_ids={table_ids}&geo_ids={geoids}"
